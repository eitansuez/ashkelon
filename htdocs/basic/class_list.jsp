...
<% } %>
  ...
  <TD><A HREF="cls.main.do?cls_id=<%=cls.getId()%>" TITLE="<%=HtmlUtils.cleanAttributeText(clsDescr)%>"><SPAN CLASS="<%=classtype%>"><%=(qualify) ? cls.getQualifiedName() : cls.getName()%></SPAN></A></TD>
  <TD><%=clsDescr%></TD>
</TR>
<% } // end for %>

...
<% } %>
  ...
  <TD><A HREF="index.html?cmd=cls.main&cls_id=<%=cls.getId()%>" TITLE="<%=HtmlUtils.cleanAttributeText(clsDescr)%>"><SPAN CLASS="<%=classtype%>"><%=(qualify) ? cls.getQualifiedName() : cls.getName()%></SPAN></A></TD>
  <TD><%=clsDescr%></TD>
</TR>
<% } // end for %>

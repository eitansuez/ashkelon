...
public class RefManager
{
   ...
   public static RefQuerySpec[] REFSPECS = {RefQuerySpec.FIELDTYPE, RefQuerySpec.METHODRETURNTYPE, 
         RefQuerySpec.IIMPLTYPE, RefQuerySpec.THROWNEXCEPTIONTYPE, 
         RefQuerySpec.PARAMTYPE, RefQuerySpec.SUPERTYPE};
   
   public RefManager(Connection conn)
   {
      this.conn = conn;
   }

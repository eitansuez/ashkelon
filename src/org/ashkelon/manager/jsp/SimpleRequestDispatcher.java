...
public class SimpleRequestDispatcher implements RequestDispatcher
{
   ...
   {
      // TBD : may not be necessary for my purposes
   }

   /*
    * this is obviously flawed / needs a lot of work
    */
   public void include(ServletRequest request, ServletResponse response) throws ServletException, IOException
   {
      ...
      else  // assume jsp (for now) (yeah i know this sucks)
      {
         try
         {
            // strip off leading foreslash "/xyz.jsp" -> "xyz.jsp"
